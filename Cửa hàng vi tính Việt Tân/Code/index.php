<?php
    ...
    // Xử lý điều hướng URL
    if (!isset($_GET['url'])) {
        require_once "views/home.php"; // Trang chủ mặc định
    } else {
        switch ($_GET['url']) {
            case 'trang-chu':
            ...
            default:
                require_once "views/not-page.php"; // Trang lỗi 404
                break;
        }
    }

    // Import các thành phần giao diện khác
