<?php
require_once "config/config.php"; // Đảm bảo bạn đã import file config.php

class ProductModel {
    private $db;

    public function __construct() {
        // Sử dụng hàm pdo_get_connection() để khởi tạo kết nối PDO
    ...
    public function select_products_by_cate($category_id, $min_price = null, $max_price = null) {
    ...
    public function select_products_by_price($min_price, $max_price) {
        $sql = "SELECT * FROM products WHERE sale_price BETWEEN ? AND ?";
