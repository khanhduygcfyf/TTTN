                        ...
                        <div class="row mt-2">
                            ...
                            <div class="list-group col-12 p-0" style="border: none;">
                                ...
                                <a href="index.php?url=dang-xuat" class="list-group-item list-group-item-action">Đăng
                                    xuất</a>
                                <a href="admin" class="list-group-item list-group-item-action">Quản lý</a>
                            </div>
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-9">
                                <p class="mb-0"><?= isset($_SESSION['user']['points']) ? $_SESSION['user']['points'] . ' điểm' : '0 điểm' ?></p>
                            </div>
                        </div>
                        <hr>
                        <div class="row">
                            <div class="col-sm-3">
                                <p class="mb-0">Cấp bậc</p>
                            </div>
                            <div class="col-sm-9">
                                <p class="mb-0"><?= isset($_SESSION['user']['level']) ? $_SESSION['user']['level'] : 'Thành viên mới' ?></p>
                            </div>
                        </div>
                        <hr>
                        <div class="row">
