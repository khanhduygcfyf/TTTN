    ...
    if(!isset($_GET['quanli'])) {
        ...
        switch ($_GET['quanli']) {
            ...
            case 'them-hoa-don':
                ...
                break;
            case 'bao-hanh':
                require_once "bao-hanh/warranty.php";         
                break;
            case 'them-bao-hanh':
                require_once "bao-hanh/add_warranty.php";         
                break;
            case 'cap-nhat-bao-hanh':
                require_once "bao-hanh/update_warranty.php";         
                break;
            case 'xoa-bao-hanh':
                require_once "bao-hanh/delete_warranty.php";         
                break;
            ...
            case 'submit-evaluation':
                if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                    ...
                    $CommentModel->insert_evaluation($user_id, $product_id, $rating, $comment);
                    header("Location: index.php?url=chitietsanpham&id_sp=$product_id");
                }
                break;
        }
    }
