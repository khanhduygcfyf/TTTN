...
<body>
    ...
    <a href="#" id="cart" class="btn btn-primary">giỏ hàng</a>
    ...
    <div class="container pt-4">
        <article class="card">
            ...
            <div class="card-body">
                <h6 class="my-1 text-black">Mã đơn hàng: OD45345345435</h6>
                <article class="card">
                    <div class="card-body row">
                        <div class="col text-black"> <strong >Thời gian giao ước tính:</strong> <br>12-12-2023</div>
                        <div class="col text-black" > <strong >Vận chuyển: </strong> <br> Giao hàng tiết kiệm</div>
                        <div class="col text-black"> <strong >Trạng thái:</strong> <br> Chờ xác nhận </div>
                        <div class="col text-black"> <strong >Tracking #:</strong> <br> BD045903594059 </div>
                    </div>
                </article>
                <div class="track">
                    <div class="step active"> <span class="icon"> <i class="fa fa-check text-black"></i> </span> <span
                            class="text">Xác nhận đặt hàng</span> </div>
                    <div class="step active"> <span class="icon"> <i class="fa fa-user text-black"></i> </span> <span class="text text-black">
                            Đã gửi vận chuyển</span> </div>
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <p class="mb-0 text-right">Le Khanh Duy</p>
                                    </div>
                                </div>
                                <hr>
                                <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <p class="mb-0 text-right">100000đ</p>
                                    </div>
                                </div>
                                <hr>
                                <div class="row">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <p style="font-size: 1.5rem;" class="mb-0 text-right text-danger fw-500">100.000đ</p>
                                    </div>
                                </div>
                    ...
                    <div class="border-bottom p-4">
                        <div class="osahan-user text-center">
                            <div class="osahan-user-media">
                                <img class="mb-3 img-thumbnail rounded-pill shadow-sm mt-1"
                                    src="./img/product/book-1.jpg" alt="gurdeep singh osahan">
                    ...
                    <ul class="nav nav-tabs flex-column border-0 pt-4 pl-4 pb-4" id="myTab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link" id="orders-tab" data-toggle="tab" href="#orders" role="tab"
                                aria-controls="orders" aria-selected="false"><i class="icofont-food-cart"></i>
                                Orders</a>
                        </li>
                    </ul>
                </div>
                        ...
                        <div class="tab-pane  fade  active show" id="orders" role="tabpanel"
                            ...
                            <div class="bg-white card mb-4 order-list shadow-sm">
                                <div class="gold-members p-4">
                                    ...
                                    <div class="media">
                                        <a href="#">
                                            <img class="mr-4" s src="./img/product/book-1.jpg"
                                        ...
                                        <div class="media-body">
                                            ...
                                            <hr>
                                            <div class="float-right">
                                                <a class="btn btn-sm btn-outline-primary" href="#">XEM CHI TIẾT</a>
                                                <a class="btn btn-sm btn-primary" href="#">MUA LẠI</a>
                                            </div>
                            ...
                            <div class="bg-white card mb-4 order-list shadow-sm">
                                <div class="gold-members p-4">
                                    ...
                                    <div class="media">
                                        <a href="#">
                                            <img class="mr-4" src="https://bootdey.com/img/Content/avatar/avatar3.png"
                                                alt="Generic placeholder image">
                                        </a>
                                        <div class="media-body">
                                            <a href="#">
                                            ...
                                            <p class="text-gray mb-1"><i class="icofont-location-arrow"></i> 1733 Ocean
                                                Ave, Santa Monica, CA 90401, USA
                                            </p>
                                            <p class="text-gray mb-3"><i class="icofont-list"></i> ORDER #25102589748 <i
                                                    class="icofont-clock-time ml-2"></i> Mon, Nov 12, 6:26 PM</p>
                                            <p class="text-dark">Veg Masala Roll x 5, Veg Burger x 1, Veg Penne Pasta in
                                                Red Sauce x 1
                                            </p>
                                            <hr>
                                            <div class="float-right">
                            ...
                            <div class="bg-white card  order-list shadow-sm">
                                <div class="gold-members p-4">
                                    ...
                                    <div class="media">
                                        <a href="#">
                                            <img class="mr-4" src="https://bootdey.com/img/Content/avatar/avatar4.png"
                                                alt="Generic placeholder image">
                                        </a>
                                        <div class="media-body">
                                            <a href="#">
                                            ...
                                            <p class="text-gray mb-1"><i class="icofont-location-arrow"></i> 953 S Main
                                                St, Centerville, OH 45459, USA
                                            </p>
                                            <p class="text-gray mb-3"><i class="icofont-list"></i> ORDER #25102589748 <i
                                                    class="icofont-clock-time ml-2"></i> Mon, Nov 12, 6:26 PM</p>
