            ...
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100">
                    ...
                    <a href="index.php?quanli=danh-sach-khach-hang" class="nav-item nav-link"><i
                            class="fas fa-users me-2"></i>Tài khoản</a>
                    <a href="index.php?quanli=binh-luan" class="nav-item nav-link"><i
                            class="fas fa-comment me-2"></i>Bình luận</a>
                    <a href="index.php?quanli=bao-hanh" class="nav-item nav-link"><i
                            class="fas fa-comment me-2"></i>Quản lý bảo hành</a>
        ...
        <div class="content">
            ...
            <style>
                .menu {
                    ...
                    padding: 0; /* Loại bỏ khoảng cách thụt vào */
